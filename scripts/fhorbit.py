...
LOG              = None
RUNNING          = True
DESIRED_PITCH    = 0.20 # angle in radians to point downward
RELEASED         = False
# PARACHUTE_HEIGHT = 1500
# RELEASE_HEIGHT   = 19000
...
def switch_ascent():
  ...
  if location['altitude'] > 15000 and ASCENT_TIMES.get('15000') == None:
    ASCENT_TIMES['15000'] = time.time()
  if location['altitude'] > 17000 and ASCENT_TIMES.get('17000') == None:
